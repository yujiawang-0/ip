...
2. Download the latest ```.jar``` file from [here](https://github.com/yujiawang-0/ip) under Releases (on the right side).
...
<img width="3063" height="1818" alt="Ui png" src="https://github.com/user-attachments/assets/0493c5fe-1c92-4c51-8b48-c93ad971c91d" />
...
# Acknowledgments
* JUnit testing codes in ```src/test/java/prime``` were written by ChatGPT
